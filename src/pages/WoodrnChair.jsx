...
const WoodenChairs = () => {
  ...
  useEffect(() => {
    fetch('http://localhost:5000/top_categories/')
      .then(res => res.json())
      .then(data => {
        const woodenChairsCategory = data.find(v => v.title === 'Wooden Chair');
        setData(woodenChairsCategory.WoodenProducts);
      })
  ...
  return (
    <div className='px-12 py-6 m-11'>
      <div className="flex flex-wrap justify-center gap-6 overflow-x-auto">
        <h1 className='text-4xl font-medium'>Wooden Chair</h1>
